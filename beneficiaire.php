...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Division Affaire Sociale</title>
...
<link rel="stylesheet" href="pages/vendor/editor/css/jquery-te-1.4.0.css">
    ...
    <body>
        ...
        <!-- DataTables Example -->
            <div class="card ">
              <div class="card-header text-uppercase">Inscription Bénéficiaire</div>
                <div class="card-body">
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-12">
                        <label class="float-left" for="dateNaissance">Date Naissance</label>
                      ...
                      <div class="col-md-12">
                          <br>Vous avez un compte ?  <a href="./" class="badge badge-info">Connectez-vous </a>
                      </div>
                    </div>
                  </div>
                </form>
        ...
        $(document).on("click","#add_beneficiaire", function(e){
          ...
          $.ajax({
            url: 'pages/actions_beneficiaires.php',
            type: 'post',
            data: {
              nom:nom,
              postnom:postnom,
