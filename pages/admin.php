<?php 
  ...
  $req = $bd->prepare("SELECT COUNT(*) AS nbUsers FROM users ");
  $req->execute();
  $res = $req->fetch();
        ...
        <div class="row">
            ...
            <div class="card border-info o-hidden h-100">
              <div class="card-body text-info" style="margin-bottom: -30px;">
                ...
                <div class="float-right">
                  <h3 style="font-size: 35px;"><?php echo $res['nbUsers'] ?></h3>
                <p class="float-right" style="font-weight: bold;"> Utilisateurs </p>
                </div>
              </div>
              <a class="card-footer text-info clearfix small z-10" href="gUsers">
          ...
          <div class="col-md-4 spacer" >
            <div class="card border-primary o-hidden h-100">
              ...
              <a class="card-footer text-primary clearfix small z-10" href="listBeneficiaires">
                <h6 class="float-left">Voir</h6>
                <h6 class="float-right">
                  <i class="fas fa-angle-right"></i>
                </h6>
          ...
          <div class="col-md-4 spacer" >
            <div class="card border-success o-hidden h-100">
              ...
              <a class="card-footer text-success clearfix small z-10" href="listBeneficiaires">
                <h6 class="float-left">Voir</h6>
                <h6 class="float-right">
                  <i class="fas fa-angle-right"></i>
                </h6>
